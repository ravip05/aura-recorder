 ...
 */
function notifyComplete(blobId, duration) {
    const msg = { action: 'RECORDING_COMPLETE', blobId, duration };
...
function handleSetMicMuted(muted) {
    if (micGainNode) {
        ...
        try {
            switch (message.action) {
                ...
                case 'RESUME_RECORDING':
                    ...
                    break;
                case 'SET_MIC_MUTED':
                    handleSetMicMuted(message.muted);
                    break;
                default:
                    break;
            }
